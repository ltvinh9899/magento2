...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'CustomModules_CurrencyRate' => 1,
        'CustomModules_Feeds' => 1,
        'CustomModules_ProductApi' => 1,
        'CustomModules_WeatherWidget' => 1,
        ...
        'MyModules_ExchangeRateBlock' => 1,
        'MyModules_LiveChat' => 1,
        'Temando_Shipping' => 1,
        'Vertex_Tax' => 1,
